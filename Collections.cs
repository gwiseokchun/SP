...
namespace LGCNS.ezControl.Common
{
    ...
    public class SortableList<T> : List<T>
    {
        ...
        /// </summary>
        /// <param name="strFields">Properties to sort objects by</param>
        /// <param name="bStringToInt">비교시 string 이 숫자 타입이면 Int 형태로 Sort</param>
        ...
        /// <summary>
        /// 기본은 해당 Feild 의 값이 Value 와 동일한 것만 찾음.
        /// bNot 이 true 인 경우는 해당 Field 의 값이 value 와 다른 것을 모두 찾음.
        /// </summary>
        ...
        /// <summary>
        /// Field == value1 or value2 or ....value n  인것 찾기.
        /// </summary>
